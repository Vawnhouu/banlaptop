<div class="row">
		...
		<input style="width:250px"class="input"type='text1' name='username' placeholder="Tên đăng nhập" /> <br><br>
		<input style="width:250px"class="input" type='password' name='password' placeholder="Mật khẩu" /> <br><br>
