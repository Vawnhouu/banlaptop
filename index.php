        ...
        <script>
            ...
            async function thanhToanThanhCong() {
                ...
                function checkPass(n){
                    ...
                    if(n==1){
                        if(passOld!=pass) document.getElementById("tb1").innerText="Mật khẩu cũ không chính xác!!!";
                            else document.getElementById("tb1").innerText="";
                    }else if(n==2){
                        if(passNew1==pass) document.getElementById("tb2").innerText="Mật khẩu mới trùng với mật khẩu cũ!!!";
